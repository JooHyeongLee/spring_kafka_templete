package com.example.spring_kafka_templete.common;
...
public class LogHandler {
    public static void setLog(String level, String service, String error, String topic, Map<String, Object> res) {
        ...
        logD.put("topic", topic);
        logD.put("timestamp", nowFormat);
        logD.put("message", mes);
